...
const debug = require("debug")("eslint:file-util:ignored-paths");
 ...
 * @param {string} ignoreFileName Name of the ignore file
 * @returns {string} Path of ignore file or an empty string.
 */
function findIgnoreFile(cwd, ignoreFileName) {
    cwd = cwd || DEFAULT_OPTIONS.cwd;
    ignoreFileName = ignoreFileName || DEFAULT_OPTIONS.ignoreFileName;

    const ignoreFilePath = path.resolve(cwd, ignoreFileName);
 ...
 * @constructor
 * @class IgnoredPaths
 * @param {Object} options object containing 'ignore', 'ignorePath', 'ignoreFileName' and 'patterns' properties
 */
function IgnoredPaths(options) {
    ...
    if (options.ignore !== false) {
        ...
        if (options.ignorePath) {
            ...
            ignorePath = findIgnoreFile(options.cwd, options.ignoreFileName);
